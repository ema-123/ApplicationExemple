...
public class LigneCommandeServiceImpl implements LigneCommandeService {
    ...
    @Transactional(readOnly = true, value = "EtgDbTransactionManager")
    @Override
    public LigneCommande getByNumero(int numero) {
        Map<String, Object> numeroMap = new HashMap<>();
        numeroMap.put("numero", numero);

        LOGGER.debug("Finding LigneCommande by unique keys: {}", numeroMap);
        LigneCommande ligneCommande = this.wmGenericDao.findByUniqueKey(numeroMap);

        if (ligneCommande == null){
            LOGGER.debug("No LigneCommande found with given unique key values: {}", numeroMap);
