...
import ch.etg.application.exemple.etgdb.service.EtgDbProcedureExecutorService;

@RestController(value = "EtgDb.ProcedureExecutionController")
@RequestMapping("/EtgDb/procedureExecutor")
...
public class ProcedureExecutionController {
    ...
    @Autowired
    private EtgDbProcedureExecutorService procedureService;
