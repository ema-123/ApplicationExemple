...
/**
 * Specifies methods used to obtain and modify StatutCommande related information
 * which is stored in the database.
 */
@Repository("EtgDb.StatutCommandeDao")
public class StatutCommandeDao extends WMGenericDaoImpl<StatutCommande, Integer> {
