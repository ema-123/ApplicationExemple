...
public class CommandeServiceImpl implements CommandeService {
    ...
    @Transactional(readOnly = true, value = "EtgDbTransactionManager")
    @Override
    public Commande getByNumero(int numero) {
        Map<String, Object> numeroMap = new HashMap<>();
        numeroMap.put("numero", numero);

        LOGGER.debug("Finding Commande by unique keys: {}", numeroMap);
        Commande commande = this.wmGenericDao.findByUniqueKey(numeroMap);

        if (commande == null){
            LOGGER.debug("No Commande found with given unique key values: {}", numeroMap);
