...
import ch.etg.application.exemple.etgdb.service.EtgDbQueryExecutorService;

@RestController(value = "EtgDb.QueryExecutionController")
@RequestMapping("/EtgDb/queryExecutor")
...
public class QueryExecutionController {
    ...
    @Autowired
    private EtgDbQueryExecutorService queryService;
