...
@Service
public class EtgDbQueryExecutorServiceImpl implements EtgDbQueryExecutorService {

    private static final Logger LOGGER = LoggerFactory.getLogger(EtgDbQueryExecutorServiceImpl.class);

    @Autowired
    @Qualifier("EtgDbWMQueryExecutor")
