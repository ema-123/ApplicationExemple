...
/**
 * Specifies methods used to obtain and modify Commande related information
 * which is stored in the database.
 */
@Repository("EtgDb.CommandeDao")
public class CommandeDao extends WMGenericDaoImpl<Commande, Integer> {
