...
import ch.etg.application.exemple.etg.service.EtgProcedureExecutorService;

@RestController(value = "Etg.ProcedureExecutionController")
@RequestMapping("/etg/procedureExecutor")
...
public class ProcedureExecutionController {
    ...
    @Autowired
    private EtgProcedureExecutorService procedureService;
