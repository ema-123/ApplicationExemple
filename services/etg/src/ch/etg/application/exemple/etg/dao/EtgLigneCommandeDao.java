...
/**
 * Specifies methods used to obtain and modify EtgLigneCommande related information
 * which is stored in the database.
 */
@Repository("etg.EtgLigneCommandeDao")
public class EtgLigneCommandeDao extends WMGenericDaoImpl<EtgLigneCommande, EtgLigneCommandeId> {
