...
@Service
public class EtgQueryExecutorServiceImpl implements EtgQueryExecutorService {

    private static final Logger LOGGER = LoggerFactory.getLogger(EtgQueryExecutorServiceImpl.class);

    @Autowired
    @Qualifier("etgWMQueryExecutor")
