...
public class EtgArticleController {
    ...
    @ApiOperation(value = "Returns the EtgArticle instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EtgArticle getEtgArticle(@PathVariable("id") Integer id) throws EntityNotFoundException {
        LOGGER.debug("Getting EtgArticle with id: {}" , id);

        EtgArticle foundEtgArticle = etgArticleService.getById(id);
        LOGGER.debug("EtgArticle details with id: {}" , foundEtgArticle);

        return foundEtgArticle;
    }

    @ApiOperation(value = "Updates the EtgArticle instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PUT)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EtgArticle editEtgArticle(@PathVariable("id") Integer id, @RequestBody EtgArticle etgArticle) throws EntityNotFoundException {
        LOGGER.debug("Editing EtgArticle with id: {}" , etgArticle.getId());

        etgArticle.setId(id);
        etgArticle = etgArticleService.update(etgArticle);
        LOGGER.debug("EtgArticle details with id: {}" , etgArticle);

        return etgArticle;
    }

    @ApiOperation(value = "Deletes the EtgArticle instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.DELETE)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteEtgArticle(@PathVariable("id") Integer id) throws EntityNotFoundException {
        LOGGER.debug("Deleting EtgArticle with id: {}" , id);

        EtgArticle deletedEtgArticle = etgArticleService.delete(id);

        return deletedEtgArticle != null;
    }
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EtgArticle getByNumero(@PathVariable("numero") Integer numero) {
