...
public class EtgCommandeController {
    ...
    @ApiOperation(value = "Returns the EtgCommande instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EtgCommande getEtgCommande(@PathVariable("id") Integer id) throws EntityNotFoundException {
        LOGGER.debug("Getting EtgCommande with id: {}" , id);

        EtgCommande foundEtgCommande = etgCommandeService.getById(id);
        LOGGER.debug("EtgCommande details with id: {}" , foundEtgCommande);

        return foundEtgCommande;
    }

    @ApiOperation(value = "Updates the EtgCommande instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PUT)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EtgCommande editEtgCommande(@PathVariable("id") Integer id, @RequestBody EtgCommande etgCommande) throws EntityNotFoundException {
        LOGGER.debug("Editing EtgCommande with id: {}" , etgCommande.getId());

        etgCommande.setId(id);
        etgCommande = etgCommandeService.update(etgCommande);
        LOGGER.debug("EtgCommande details with id: {}" , etgCommande);

        return etgCommande;
    }

    @ApiOperation(value = "Deletes the EtgCommande instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.DELETE)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteEtgCommande(@PathVariable("id") Integer id) throws EntityNotFoundException {
        LOGGER.debug("Deleting EtgCommande with id: {}" , id);

        EtgCommande deletedEtgCommande = etgCommandeService.delete(id);
