...
import ch.etg.application.exemple.etg.service.EtgQueryExecutorService;

@RestController(value = "Etg.QueryExecutionController")
@RequestMapping("/etg/queryExecutor")
...
public class QueryExecutionController {
    ...
    @Autowired
    private EtgQueryExecutorService queryService;
