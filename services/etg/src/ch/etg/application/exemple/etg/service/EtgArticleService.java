...
public interface EtgArticleService {
	 ...
	 */
	EtgArticle getById(EtgArticleId etgarticleId) throws EntityNotFoundException;
	 ...
	 * @return EtgArticle associated with the given etgarticleId.
	 */
	EtgArticle findById(EtgArticleId etgarticleId);
	 ...
	 */
    EtgArticle getByNumero(int numero)throws EntityNotFoundException;

    /**
	 * Find and return the EtgArticle for given id  if exists.
	 *
	 * @param id value of id; value cannot be null.
	 * @return EtgArticle associated with the given inputs.
     * @throws EntityNotFoundException if no matching EtgArticle found.
	 */
    EtgArticle getByUniqueKeyId(int id)throws EntityNotFoundException;
	 ...
	 */
	EtgArticle delete(EtgArticleId etgarticleId) throws EntityNotFoundException;
    ...
    /*
     * Returns the associated etgLigneCommandes for given EtgArticle id.
     *
     * @param id value of id; value cannot be null
     * @param numero value of numero; value cannot be null
     * @param libelle value of libelle; value cannot be null
     * @param prix value of prix; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<EtgLigneCommande> findAssociatedEtgLigneCommandes(Integer id, Integer numero, String libelle, BigDecimal prix, Pageable pageable);
